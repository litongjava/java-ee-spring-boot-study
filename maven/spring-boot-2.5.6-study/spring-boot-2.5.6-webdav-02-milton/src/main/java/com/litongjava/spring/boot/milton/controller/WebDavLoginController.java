package com.litongjava.spring.boot.milton.controller;
...
import com.litongjava.spring.boot.milton.config.MiltonProperties;
 ...
 */
@RestController
@RequestMapping("/webdav/auth")
public class WebDavLoginController {
  @Autowired
  ...
  public void login(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (!miltonProperties.getUsername().equals(username) && !miltonProperties.getPassword().equals(password)) {
      error(response);
      return;
    }

...
public class Config {
  ...
  public void setThreadLocalConnection(Connection connection) {
    ...
    // System.out.println("当前线程2-1:"+Thread.currentThread().getId()+ "对象:" +
  ...
  public void removeThreadLocalConnection() {
    // System.out.println("当前线程2-3:"+Thread.currentThread().getId() + "准备释放对象:"
    // + this.threadLocal.get());
    // 移除事务层
  ...
  public Connection getConnection() throws SQLException {
    // System.out.println("当前线程2-2:"+Thread.currentThread().getId() + "对象:" +
    // this.threadLocal.get());

...
import top.ppnt.model.Film;
import top.ppnt.vo.ResultModel;
...
public class FilmController {
  ...
  public ResultModel<Void> addFilm(@ApiParam("电影名称") @RequestParam("filmName") String filmName,
  ...
  public ResultModel<List> getFilmsByName(@ApiParam("电影名称") @RequestParam("fileName") String fileName) {
    return null;
  }
  ...
  @ApiResponses(value = { @ApiResponse(code = 1000, message = "成功"), @ApiResponse(code = 1001, message = "失败"),
      @ApiResponse(code = 1002, message = "缺少参数") })
  public ResultModel<Void> updateFilmScore(@ApiParam("电影名称") @RequestParam("fileName") String fileName,
  ...
  public ResultModel<Void> deleteFilmByNameOrId(HttpServletRequest request) {
    return null;
  }
  ...
  public ResultModel<Film> getFilmById(@PathVariable Long id) {
  ...
  @ApiOperation("插入一部电影")
  public ResultModel<Void> insertFilm(@ApiParam("电影实体对象") @RequestBody Film film) {
    return null;
  }
}